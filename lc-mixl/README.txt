...
- You specify your model by changing the options in "r.script.run.lc.mixl.R". This is the only file you need to change to run your model. The last line of this file: "fn.run.model()", will initiate the run sequence. 
...
- This is a complex model and you may experience convergence issues. The model is susceptible to local optima.
