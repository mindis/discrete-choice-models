...
##                          outputs
################################################################################
EstimOpt$strModelName <- "Latent Class - Mixed Logit Model -- LC-MIXL"
EstimOpt$strOutputFile <- "output.lc.mixl.coral"
