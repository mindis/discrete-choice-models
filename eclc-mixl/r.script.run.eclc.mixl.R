...
source("r.script.ll.eclc.mixl.R")
...
##                          outputs
################################################################################
EstimOpt$strModelName <- "Equality Constrained Latent Class - Mixed Logit Model -- ECLC-MIXL"
EstimOpt$strOutputFile <- "output.eclc.mixl.coral"
