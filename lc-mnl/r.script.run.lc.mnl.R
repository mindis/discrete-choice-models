...
##                          outputs
################################################################################
EstimOpt$strModelName <- "Latent Class - Multinomial Logit Model -- LC-MNL"
EstimOpt$strOutputFile <- "output.lc.mnl.coral"
...
################################################################################
EstimOpt$strP_fixed <- c("cost", "small", "large", "oil", "fish", "hab")
