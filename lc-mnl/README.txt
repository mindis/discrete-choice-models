...
This is the code for estimating the standard latent class model. The model allows to specify the number of classes and include socio-demographic variables in the class probability function. The model can be estimated in preference space and WTP space, although the WTP-space specification is highly unstable.
